...
void    editBonusCP(int modNum, bool flagDown = false);/*                              Increment or Decriment culture file bonus cp.
Preconditions:
    Optional bool flag to decriment.
    Input int.
Postconditions:
    bonus CP modified by +-int
*/

void    editLevel(int modNum, bool flagDown = false);/*                              Increment or Decriment culture file bonus cp.
Preconditions:
    Optional bool flag to decriment.
    Input int.
Postconditions:
    Culture Level modified by +-int
*/
